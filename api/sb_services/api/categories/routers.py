...
async def add_category(new_cat: CategoryScheme,
    ...
    await producer.service_category_created(category_id=new_category.id)
...
async def edit_category(updated_cat: CategoryScheme,
    ...
    await producer.service_category_updated(category_id=updated_category.id)
...
async def delete_category(cat_id: int = Path(...),
    ...
    await producer.service_category_deleted(category_id=cat_id)
