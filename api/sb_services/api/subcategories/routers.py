...
async def add_subcategory(new_subcat: SubcategoryScheme,
    ...
    await producer.service_subcategory_created(subcategory_id=new_subcategory.id)
...
async def edit_subcategory(updated_subcat: SubcategoryScheme,
    ...
    await producer.service_subcategory_updated(subcategory_id=updated_subcategory.id)
...
async def delete_subcategory(subcat_id: int = Path(...),
    ...
    await producer.service_subcategory_deleted(subcategory_id=subcat_id)
